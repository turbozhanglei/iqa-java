package com.yechtech.dac.generator;
...
public class CodeGenerator {
    ...
    // 数据库 URL
    private static final String URL = "jdbc:mysql://192.168.31.145:3306/dap_db_dev?useUnicode=true&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
    // 数据库驱动
    ...
    // @author 值
    private static final String AUTHOR = "James";
    // 包的基础路径
    private static final String BASE_PACKAGE_URL = "com.yechtech.dac";

    private static final String MODULE_NAME="user";
    // xml文件路径
    private static final String XML_PACKAGE_URL = "/src/main/resources/mapping";
    // xml 文件模板
    ...
    public static void main(String[] args) {
        ...
        // 如果模板引擎是 freemarker
        String templatePath = XML_MAPPER_TEMPLATE_PATH+".ftl";
        // 如果模板引擎是 velocity
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输出文件名
                return projectPath + XML_PACKAGE_URL
...
//                // 自定义输出文件名
//                return projectPath + XML_PACKAGE_URL
//                        + "/" + tableInfo.getEntityName().substring(1) + "Mapper" + StringPool.DOT_JAVA;
//            }
//        });
...
//        strategy.setSuperEntityColumns("id");
        ...
        strategy.setTablePrefix(String.format("t_%s", MODULE_NAME));
